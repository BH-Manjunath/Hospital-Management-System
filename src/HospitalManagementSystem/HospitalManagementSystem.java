...
public class HospitalManagementSystem {
    ...
    private static final String password = "Anushashetty@2002";

    public static void main(String[] args){
        try{
            Class.forName("com.mysql.cj.jdbc.Driver");
            //Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/hospital", "root", "your_password");
